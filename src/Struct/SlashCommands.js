const commandData = [
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                name: 'mute',
                type: 'STRING',
                description: 'Mute yourself for a specified time because why not? Ex: 11m',
                required: false
            }
        ]
    },
    ...
    {
        name: 'nickname',
        description: 'Change someone\'s nickname using premade options or the typical way',
        options: [
            {
                name: 'user',
    ...
    {
        name: 'move',
        description: 'Off-topic conversation in a channel? Use this command to move them.',
        options: [
            {
                name: 'channel',
                type: 'CHANNEL',
